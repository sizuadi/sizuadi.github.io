...
const socialMedias = [
	...
	{
		name: "LinkedIn",
		link: "https://www.linkedin.com/in/adi-siswanto/",
		icon: `<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
					fill="currentColor"
	...
	{
		name: "Instagram",
		link: "https://instagram.com/adisswnt",
		icon: `<svg
					xmlns="http://www.w3.org/2000/svg"
	...
	{
		name: "Twitter",
		link: "https://twitter.com/NekozuTech",
		icon: `<svg
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 248 204"
				fill="currentColor"
		...
		<div>
			<ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
				{socialMedias.map((socialMedia, key) => {
					return (
						<li className="mr-5 text-xs" key={key}>
							<a
